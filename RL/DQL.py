...
class DQL:
    def __init__(self, state_size, action_size, batch_size, learning_rate = 0.01 , gamma = 0.9 , epsilon = 0.9, update_rate = 10, flag = False):
        ...
        self.main_network = MLP_RL.MLP(self.state_size, hidden_layer, self.action_size)
        ...
        #define the target 
        self.target_network =  MLP_RL.MLP(self.state_size, hidden_layer, self.action_size)
